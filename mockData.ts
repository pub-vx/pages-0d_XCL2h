...
export interface Airport {
  ...
  latitude: number;
  longitude: number;
  region: string; // 일본 지역 (필터링용)
  tier: 'hub' | 'regional'; // hub: 항상 노출 / regional: 줌인/지역 단일 선택 시 노출
}

export const airports: Airport[] = [
  // ====== 허브 공항 (항상 노출) ======
  { id: 'fukuoka',      name: '후쿠오카 공항',    code: 'FUK', latitude: 33.5859, longitude: 130.4505, region: '규슈',     tier: 'hub' },
  { id: 'narita',       name: '나리타 공항',      code: 'NRT', latitude: 35.7720, longitude: 140.3929, region: '간토',     tier: 'hub' },
  { id: 'haneda',       name: '하네다 공항',      code: 'HND', latitude: 35.5494, longitude: 139.7798, region: '간토',     tier: 'hub' },
  { id: 'kansai',       name: '간사이 공항',      code: 'KIX', latitude: 34.4347, longitude: 135.2440, region: '간사이',   tier: 'hub' },
  { id: 'chubu',        name: '중부 국제공항',    code: 'NGO', latitude: 34.8584, longitude: 136.8053, region: '주부',     tier: 'hub' },
  { id: 'shin-chitose', name: '신치토세 공항',    code: 'CTS', latitude: 42.7752, longitude: 141.6923, region: '홋카이도', tier: 'hub' },
  { id: 'naha',         name: '나하 공항',        code: 'OKA', latitude: 26.1958, longitude: 127.6458, region: '오키나와', tier: 'hub' },

  // ====== 지방공항 (줌인 또는 단일 지역 선택 시 노출) ======
  // 규슈
  { id: 'kitakyushu', name: '키타큐슈 공항', code: 'KKJ', latitude: 33.8456, longitude: 131.0350, region: '규슈', tier: 'regional' },
  { id: 'kagoshima',  name: '가고시마 공항', code: 'KOJ', latitude: 31.8034, longitude: 130.7196, region: '규슈', tier: 'regional' },
  { id: 'miyazaki',   name: '미야자키 공항', code: 'KMI', latitude: 31.8772, longitude: 131.4486, region: '규슈', tier: 'regional' },
  { id: 'kumamoto',   name: '구마모토 공항', code: 'KMJ', latitude: 32.8373, longitude: 130.8550, region: '규슈', tier: 'regional' },
  { id: 'oita',       name: '오이타 공항',   code: 'OIT', latitude: 33.4794, longitude: 131.7372, region: '규슈', tier: 'regional' },
  { id: 'nagasaki',   name: '나가사키 공항', code: 'NGS', latitude: 32.9169, longitude: 129.9136, region: '규슈', tier: 'regional' },
  { id: 'saga',       name: '사가 공항',     code: 'HSG', latitude: 33.1497, longitude: 130.3025, region: '규슈', tier: 'regional' },
  // 간토
  { id: 'ibaraki',    name: '이바라키 공항', code: 'IBR', latitude: 36.1811, longitude: 140.4147, region: '간토', tier: 'regional' },
  // 주부
  { id: 'shizuoka',   name: '시즈오카 공항', code: 'FSZ', latitude: 34.7961, longitude: 138.1878, region: '주부', tier: 'regional' },
  { id: 'komatsu',    name: '코마츠 공항',   code: 'KMQ', latitude: 36.3947, longitude: 136.4067, region: '주부', tier: 'regional' },
  { id: 'toyama',     name: '토야마 공항',   code: 'TOY', latitude: 36.6483, longitude: 137.1881, region: '주부', tier: 'regional' },
  // 주고쿠
  { id: 'hiroshima',  name: '히로시마 공항', code: 'HIJ', latitude: 34.4361, longitude: 132.9197, region: '주고쿠', tier: 'regional' },
  { id: 'okayama',    name: '오카야마 공항', code: 'OKJ', latitude: 34.7569, longitude: 133.8556, region: '주고쿠', tier: 'regional' },
  { id: 'yonago',     name: '요나고 공항',   code: 'YGJ', latitude: 35.4922, longitude: 133.2364, region: '주고쿠', tier: 'regional' },
  // 시코쿠
  { id: 'takamatsu',  name: '다카마쓰 공항', code: 'TAK', latitude: 34.2142, longitude: 134.0156, region: '시코쿠', tier: 'regional' },
  { id: 'matsuyama',  name: '마쓰야마 공항', code: 'MYJ', latitude: 33.8272, longitude: 132.6997, region: '시코쿠', tier: 'regional' },
  // 도호쿠
  { id: 'sendai',     name: '센다이 공항',   code: 'SDJ', latitude: 38.1397, longitude: 140.9170, region: '도호쿠', tier: 'regional' },
  { id: 'aomori',     name: '아오모리 공항', code: 'AOJ', latitude: 40.7347, longitude: 140.6906, region: '도호쿠', tier: 'regional' },
  { id: 'akita',      name: '아키타 공항',   code: 'AXT', latitude: 39.6156, longitude: 140.2186, region: '도호쿠', tier: 'regional' },
  // 홋카이도
  { id: 'hakodate',   name: '하코다테 공항', code: 'HKD', latitude: 41.7700, longitude: 140.8222, region: '홋카이도', tier: 'regional' },
  { id: 'asahikawa',  name: '아사히카와 공항', code: 'AKJ', latitude: 43.6708, longitude: 142.4475, region: '홋카이도', tier: 'regional' },
  // 오키나와
  { id: 'miyako',     name: '미야코 공항',   code: 'MMY', latitude: 24.7828, longitude: 125.2950, region: '오키나와', tier: 'regional' },
  { id: 'ishigaki',   name: '이시가키 공항', code: 'ISG', latitude: 24.3964, longitude: 124.2450, region: '오키나와', tier: 'regional' },
];
