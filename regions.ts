...
export const JAPAN_REGIONS_DATA: readonly JapanRegion[] = [
  { id: '규슈',     label: '규슈',     subRegions: ['후쿠오카', '오이타', '구마모토', '쿠마모토', '나가사키', '가고시마', '미야자키', '사가'] },
  { id: '간토',     label: '간토',     subRegions: ['도쿄', '치바', '사이타마', '가나가와', '카나가와', '이바라키', '도치기', '토치기', '군마'] },
  { id: '간사이',   label: '간사이',   subRegions: ['오사카', '교토', '효고', '나라', '시가', '와카야마', '미에'] },
  { id: '주부',     label: '주부',     subRegions: ['아이치', '시즈오카', '기후', '나가노', '야마나시', '니가타', '도야마', '이시카와', '후쿠이'] },
  { id: '홋카이도', label: '홋카이도', subRegions: ['홋카이도', '삿포로', '하코다테', '아사히카와', '쿠시로', '니세코'] },
  { id: '오키나와', label: '오키나와', subRegions: ['오키나와', '미야코', '이시가키'] },
  { id: '도호쿠',   label: '도호쿠',   subRegions: ['도호쿠', '미야기', '센다이', '후쿠시마', '야마가타', '이와테', '아키타', '아오모리'] },
  { id: '시코쿠',   label: '시코쿠',   subRegions: ['시코쿠', '카가와', '에히메', '도쿠시마', '고치', '마쓰야마'] },
  { id: '주고쿠',   label: '주고쿠',   subRegions: ['주고쿠', '히로시마', '오카야마', '시마네', '돗토리', '야마구치'] },
] as const;
